...
프로젝트에는 3개의 전문 에이전트가 포함되어 있습니다:

#### 🎬 quote-video-agent
- **역할**: 영상 생성 파이프라인 오케스트레이터
- **기능**: 4개 스킬(이미지, TTS, 자막, 합성)을 순차 실행
- **사용**: 전체 영상 제작 프로세스 자동화

#### ✍️ quote-writer-agent
- **역할**: 명언 콘텐츠 기획 및 씬 데이터 구성
- **기능**: 주제에 맞는 나레이션 + 이미지 프롬프트 작성
- **사용**: Scene 데이터 생성 및 콘텐츠 기획

#### 🎨 frontend-agent
- **역할**: 프론트엔드 UI/UX 전문 관리 및 개선
- **기능**: 사용자 인터페이스 설계, 개선, 유지보수
- **사용**: static/index.html UI 개선, 디자인 시스템 관리
- **담당**:
  - 반응형 디자인
  - 접근성(A11y) 개선
  - 성능 최적화
